  ...
  return (
    <UserContext.Provider value={{ 
      ...
      <div className={showProfileModal ? "relative" : ""}>
            ...
            <div className="relative max-w-md w-full p-0">
              <div className="bg-gray-900 rounded-2xl shadow-lg px-8 py-10 flex flex-col items-center animate-popIn">
                ...
                <div className="mb-4 flex items-center justify-center w-16 h-16 rounded-full bg-[#A020F0]/20 shadow-lg">
                  <svg className="w-10 h-10 text-[#A020F0]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </div>
                <h2 className="text-3xl font-extrabold text-white mb-2 text-center drop-shadow-lg">Complete Your Profile</h2>
                <p className="text-lg text-purple-400 mb-8 text-center">To unlock all features and get the best experience, please complete your profile.</p>
                ...
                <button onClick={() => setShowProfileModal(false)} className="absolute top-4 right-4 text-white text-3xl hover:text-[#A020F0] transition-colors focus:outline-none">&times;</button>
              </div>
            </div>
            <style jsx global>{`
              .animate-popIn {
        ...
        <div className={showProfileModal ? "pointer-events-none select-none blur-sm" : ""}>
      {children}
        </div>
      </div>
